    ...
    <div class="workspace-panels">
      <section id="workspace-panel-home" role="tabpanel" aria-labelledby="workspace-tab-home" data-workspace-view="home">
        ...
        <div class="workspace-entry-grid">
          ...
          <button type="button" data-entry="identity"><img class="workspace-entry-art" src="${assetRoot}/ai-dashboard/reference-v13/identity-verification-v13.webp" width="768" height="768" loading="lazy" decoding="async" alt="" aria-hidden="true" /><span>02</span><strong>台灣證號命格</strong><small>國民身分證與新式外來證號分流，輸入預設遮罩</small></button>
          <button type="button" data-entry="phone_number"><img class="workspace-entry-art" src="${assetRoot}/ai-dashboard/reference-v13/phone-resonance-v13.webp" width="768" height="768" loading="lazy" decoding="async" alt="" aria-hidden="true" /><span>03</span><strong>手機號碼磁場</strong><small>相鄰滑動配對、0／5 修飾與八大磁場</small></button>
          <button type="button" data-entry="vehicle_address"><img class="workspace-entry-art" src="${assetRoot}/ai-dashboard/reference-v13/vehicle-address-map-v13.webp" width="768" height="768" loading="lazy" decoding="async" alt="" aria-hidden="true" /><span>04</span><strong>車牌／門牌</strong><small>英數轉換與來源字元追溯</small></button>
          <button type="button" data-entry="custom_sequence"><img class="workspace-entry-art" src="${assetRoot}/ai-dashboard/reference-v13/custom-sequence-v13.webp" width="768" height="768" loading="lazy" decoding="async" alt="" aria-hidden="true" /><span>05</span><strong>自訂英數序列</strong><small>適合其他非敏感編號；不當作身分證檢查</small></button>
          <button type="button" data-entry="settings"><img class="workspace-entry-art" src="${assetRoot}/ai-dashboard/reference-v13/rule-profiles-v13.webp" width="768" height="768" loading="lazy" decoding="async" alt="" aria-hidden="true" /><span>06</span><strong>規則與版本</strong><small>主數、九宮格、0／5 與時間軸皆可明確選擇</small></button>
        </div>
