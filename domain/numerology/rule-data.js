...
export const PERSONALITY_PROFILES = Object.freeze({
  ...
  2: Object.freeze({
    ...
    labelAuthority: "photo",
    quickMeaning: "代表陪伴",
    positiveTraits: Object.freeze(["感受細膩", "關心他人", "情感表達", "舞台表達"]),
    challengeTraits: Object.freeze(["可能較在意關係", "需要安全感"]),
    socialTraits: Object.freeze(["重視陪伴", "傾向徵詢他人", "能觀察氣氛"]),
  ...
  3: Object.freeze({
    ...
    challengeTraits: Object.freeze(["對批評可能較敏感", "可能因直率產生摩擦"]),
    socialTraits: Object.freeze(["對親近者較直率", "對外較圓融", "容易帶動氣氛"]),
  ...
  4: Object.freeze({
    ...
    labelAuthority: "photo",
    quickMeaning: "代表秩序",
    positiveTraits: Object.freeze(["組織", "秩序", "消費審慎", "專業", "整理"]),
    challengeTraits: Object.freeze(["改變需要時間", "可能較重視規則"]),
    socialTraits: Object.freeze(["重視可靠與承諾", "偏好清楚界線"]),
    workTraits: Object.freeze(["擅長整理與流程", "審慎使用資源", "能維持品質"]),
  ...
  5: Object.freeze({
    ...
    labelAuthority: "photo",
    quickMeaning: "代表溝通",
    positiveTraits: Object.freeze(["表達", "口才", "飲食感受", "權衡選擇"]),
    challengeTraits: Object.freeze(["選擇前可能反覆考量", "決定後通常不易改變"]),
  ...
  6: Object.freeze({
    ...
    quickMeaning: "代表關懷",
    positiveTraits: Object.freeze(["照顧", "關懷", "傾聽", "協調", "情感支持"]),
    challengeTraits: Object.freeze(["較難拒絕他人", "不一定容易直接說出感受"]),
    socialTraits: Object.freeze(["願意支持他人", "常以微笑回應", "重視關係穩定"]),
  ...
  8: Object.freeze({
    ...
    workTraits: Object.freeze(["擅長資源配置", "重視可衡量進度", "在意表現是否被看見", "願意承擔受託責任"]),
  ...
  9: Object.freeze({
    ...
    labelAuthority: "editorial",
    quickMeaning: "代表使命",
    positiveTraits: Object.freeze(["服務", "使命", "公益", "重視跨世代關係", "理想"]),
    ...
    phraseAuthority: "photo",
    unresolvedSourceClaims: Object.freeze(["「受神明寵愛」與「吃菜命」屬原教材未定義或宗教性說法，不納入演算結論。"]),
    healthFolkloreNotes: Object.freeze([]),
    disclaimer: FOLKLORE_HEALTH_DISCLAIMER,
    sourceProfile: "uploaded-numerology-photo-2026-08-12-v1",
    sourceProfiles: Object.freeze(["uploaded-numerology-v2", "uploaded-numerology-photo-2026-08-12-v1"]),
