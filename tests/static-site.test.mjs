...
test("GitHub Pages entrypoint is numerology-first with three isolated modes and safeguards", async () => {
  ...
  assert.match(html, /https:\/\/endfew-ai\.github\.io\/e-shidai-life-code\/og-b-v2\.png/);
  ...
  await Promise.all([
    ...
    access(new URL("../og-b-v2.png", import.meta.url)),
    access(new URL("../public/og-b-v2.png", import.meta.url)),
    ...
    access(new URL("../public/visuals/birth-orbit-b-v2.webp", import.meta.url)),
    access(new URL("../public/visuals/birth-grid-b-v2.webp", import.meta.url)),
    access(new URL("../public/visuals/digit-wave-b-v2.webp", import.meta.url)),
    access(new URL("../public/visuals/digit-nodes-b-v2.webp", import.meta.url)),
    access(new URL("../public/visuals/iching-instrument-b-v2.webp", import.meta.url)),
    access(new URL("../public/visuals/iching-manuscript-b-v2.webp", import.meta.url)),
  ]);
});
