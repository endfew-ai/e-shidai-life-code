...
- `ZHOUYI-XICI-CTEXT-01`：《周易・繫辭下》，支持六爻本末、遠近與尊卑位置，不支持固定現代職稱或六等分應期。
- `ZHOUYI-ZHENGYI-CTEXT-01`：唐《周易正義》相關注疏，交叉核對經傳爻位說明。
- `YIYIN-CTEXT-V6-01`：曹九錫《易隱》卷六〈官祿占〉，後世逐爻官職類象。
- `YIYIN-CTEXT-V8-01`：曹九錫《易隱》卷八〈疾病占〉，後世逐爻人體類象；不可作醫療診斷。
- `BUSHIQUANSHU-CTEXT-V7-01`：《卜筮全書》卷七〈家宅章〉，後世逐爻家宅位置。
- `BUSHIZHENGZONG-CTEXT-01`：《卜筮正宗》〈闢易林補遺家宅之謬〉等篇，只提供不能脫離用神與卦中條件直接判吉凶的限制，不作家宅映射來源。

完整表格、現代均分公式與使用界線見 [line-position-correspondences.md](./line-position-correspondences.md)。

| Source ID | 來源 | 用途 |
|---|---|---|
| `ZHOUYI-XICI-CTEXT-01` | 中國哲學書電子化計劃《周易・繫辭下》 | 六爻本末、遠近與尊卑位置 |
| `ZHOUYI-ZHENGYI-CTEXT-01` | 中國哲學書電子化計劃唐《周易正義》相關注疏 | 經傳爻位交叉核對 |
| `YIYIN-CTEXT-V6-01` | 曹九錫《易隱》卷六〈官祿占〉 | 後世逐爻官職類象 |
| `YIYIN-CTEXT-V8-01` | 曹九錫《易隱》卷八〈疾病占〉 | 後世逐爻人體類象；不作醫療診斷 |
| `BUSHIQUANSHU-CTEXT-V7-01` | 《卜筮全書》卷七〈家宅章〉 | 後世逐爻家宅位置 |
| `BUSHIZHENGZONG-CTEXT-01` | 《卜筮正宗》〈闢易林補遺家宅之謬〉等篇 | 固定爻位不可脫離卦中條件直接判吉凶；不作映射來源 |
